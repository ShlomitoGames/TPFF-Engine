...
namespace RDEngine.GameScripts
{
    public class Level1 : Scene
    {
        ...
        public override void Initialize()
        {
            ...
            AddGameObjects(new GameObject[]
            {
                new TextObject("FPS", ContentStorer.Fonts["Arial"], "0", new Vector2(RDEGame.ScreenWidth * RDEGame.ScaleFactor - 60f, 30f), false, initialComponents: new List<GComponent>()
                {
                    new FPSCounter()
                })
                {
